...
You can close the application after toggling on/off. It simply switches your OS into a state where shutting the lid doesn't insta-kill everything. Enjoy! Share!

Install directly from GitHub Releases or using homebrew (keeps it updated) as shown below.
